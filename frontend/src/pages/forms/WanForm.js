    ...
    <Wrapper>
      ...
      >
        ...
        <FormControlLabel
          ...
          label="Следует ли включить функцию перезаписи подсказок с использованием LLM"
          value={formData.enable_prompt_expansion}
          onChange={() => handleChange('enable_prompt_expansion', !formData.enable_prompt_expansion)}
        />
